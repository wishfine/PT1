...
def train_from_odps_stream(args):
    ...
    # prepare log dir and save effective config if provided
    ...
    logging.basicConfig(level=logging.INFO, format='%(asctime)s %(levelname)s %(message)s', handlers=[logging.FileHandler(os.path.join(log_dir, 'train.log')), logging.StreamHandler()])
